          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div
                ...
                className={`w-full border-2 border-dashed rounded-lg p-6 text-center ${isUploading ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'} transition-colors ${fileName ? 'border-green-500 bg-green-50' : 'border-cyan-300 hover:border-cyan-500 hover:bg-cyan-50'
                  }`}
              >
...
const CounsellorDashboard = () => {
  ...
  useEffect(() => {
    ...
    const loadMessages = async () => {
      const cacheKey = `chat_history_counsellor_${userId}_${conversationId}`;
      try {
    ...
    const cached = getInitialCache(`chat_history_counsellor_${userId}_${conversationId}`);
